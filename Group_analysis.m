...
for i = 1:length(Exp)
    ...
    if Duration_fix == '1' % Original lenght of phase
        ...
        if LVR == 1
            [Group_LVR_RFA,LVR_Group_RFA,SPONT_Group_LVR_RFA,Group_LVR_RFA_Spont,GROUP_LVR_RS_RFA,GROUP_LVR_ES_RFA,GROUP_LVR_SS_RFA,Group_LVR_S1,LVR_Group_S1,SPONT_Group_LVR_S1,Group_LVR_S1_Spont,GROUP_LVR_RS_S1,GROUP_LVR_ES_S1,GROUP_LVR_SS_S1]= LVR_group(exp_folder,Num_Exp,LVR_Group_RFA,SPONT_Group_LVR_RFA,GROUP_LVR_RS_RFA,GROUP_LVR_ES_RFA,GROUP_LVR_SS_RFA,LVR_Group_S1,SPONT_Group_LVR_S1,GROUP_LVR_RS_S1,GROUP_LVR_ES_S1,GROUP_LVR_SS_S1);
        end
    else
        % Subphases
    end
